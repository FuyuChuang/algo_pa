...
public:
    ...
    Generator() {}
    Generator(size_t numCourses, size_t creditLimit) :
        creditLimit_(creditLimit), numCourses_(numCourses), numPrereqs_(0) {
        srand(time(NULL));
    }
    ~Generator() {}
...
private:
    size_t                      creditLimit_;       // the limit of credit for every semesters
